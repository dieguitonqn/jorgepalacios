...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-4 bg-gray-700 shadow-md rounded-md">
      ...
      <button
        type="submit"
        className="w-full bg-orange-400/50 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      >
        Enviar
      </button>
    </form>
